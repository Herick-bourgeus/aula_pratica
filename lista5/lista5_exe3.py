...
if salario <= 1903.98:
    print("Seu salario está insento de imposto")
elif salario >= 1903.99 and salario <= 2826.65:
    salario_imposto = salario * 0.075
    salario_novo = salario - salario_imposto
    print("voce ira pagar um imposto de R${:.2f}".format(salario_imposto))
    print("seu novo salario é de R${:.2f}".format(salario_novo))
